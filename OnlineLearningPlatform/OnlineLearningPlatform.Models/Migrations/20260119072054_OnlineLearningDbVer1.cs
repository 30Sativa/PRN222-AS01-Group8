...
{
    /// <inheritdoc />
    public partial class OnlineLearningDbVer1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiGeneratedExercises", x => x.ExerciseId);
                    table.ForeignKey(
                        name: "FK_AiGeneratedExercises_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscussionTopics_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId");
                    table.ForeignKey(
                        name: "FK_DiscussionTopics_Users_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiGeneratedExercises_UserId",
                table: "AiGeneratedExercises",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionTopics_CourseId",
                table: "DiscussionTopics",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionTopics_CreatedBy",
                table: "DiscussionTopics",
                column: "CreatedBy");
